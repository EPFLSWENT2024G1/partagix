...
class App(activity: MainActivity) : ComponentActivity(), SignInResultListener {
  ...
  private fun ComposeNavigationHost(
    ...
    NavHost(
      ...
      composable(Route.BORROW) { HomeScreen(navigationActions)/*TODO:Change to the borrow screen*/}
      composable(Route.INVENTORY) {
        InventoryScreen(
            inventoryViewModel = inventoryViewModel,
            navigateToTopLevelDestination = navigationActions::navigateTo)
      }
      composable(Route.ACCOUNT) { HomeScreen(navigationActions)/*TODO:Change to the account screen*/}
      composable(
